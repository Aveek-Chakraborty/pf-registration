    ...
    <div className="h-screen max:h-screen-auto flex justify-center items-center bg-gradient-to-br from-orange-500/35 via-blue-300 to-purple-400/40">
      <div className="bg-white p-8 rounded-xl shadow-lg w-5/6 h-5/7">
        <h2 className="text-4xl font-semibold mb-4 text-center ">
          Marathon 15.0 Registration - Boys
        </h2>
        <form
        ...
        >
          <div className="mb-4">
            ...
            <input
              ...
              id="name"
              required
              className="form-input border w-full h-10 rounded-lg"
              {...form.register("name")}
            />
          </div>
          <div className="mb-4">
            ...
            <input
              ...
              id="mobile"
              required
              className="form-input border w-full h-10 rounded-md"
          ...
          <button
            type="submit"
            className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition duration-300 self-center"
          >
            Submit
          </button>
        </form>
